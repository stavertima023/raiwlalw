...
export type OrderStatus = 'Добавлен' | 'Готов' | 'Отправлен' | 'Исполнен' | 'Отменен' | 'Возврат';
export type ExpenseCategory = 'Аренда' | 'Зарплата' | 'Расходники' | 'Маркетинг' | 'Налоги' | 'Другое';
