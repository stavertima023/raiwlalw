...
import { LazyPhotoGallery } from '@/components/ui/LazyImage';
...
// Мемоизированный компонент фотографий с lazy loading
const OrderPhotos = React.memo<{ photos: string[]; size: number }>(({ photos, size }) => {
  return <LazyPhotoGallery photos={photos} size={size} maxVisible={3} />;
});
